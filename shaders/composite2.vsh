...
#define SKYLIGHT_DAY_BLUE 0.6  //[0.1 0.15 0.2 0.25 0.3 0.35 0.4 0.45 0.5 0.55 0.6 0.65 0.7 0.75 0.8 0.85 0.9 0.95 1.0 1.05 1.1 1.15 1.2 1.25 1.3 1.35 1.4 1.45 1.5 1.55 1.6 1.65 1.7 1.75 1.8 1.85 1.9 1.95 2.0 2.05 2.1 2.15 2.2 2.25 2.3 2.35 2.4 2.45 2.5 2.55 2.6]
...
//colors for shadows/sunlight and sky
	...
	noon_amb	= vec3(0.15 * SKYLIGHT_DAY_RED, 0.375 * SKYLIGHT_DAY_GREEN, 1.34f * SKYLIGHT_DAY_BLUE) * 0.62f;
		if (FANTASIC_NIGHTSKY > 0){
