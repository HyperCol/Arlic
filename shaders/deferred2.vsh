...
//colors for shadows/sunlight and sky
	...
	noon_amb	= vec3(SKYLIGHT_DAY_RED, SKYLIGHT_DAY_GREEN, SKYLIGHT_DAY_BLUE) * SKYLIGHT_DAY_L;
		if (FANTASIC_NIGHTSKY > 0){
			...
			midnight_amb = vec3(0.005f, 0.25f, 1.0f) * 0.05 * SKYLIGHT_NIGHT_L;
		}
	...
	colorSunlight = mix(colorSunlight, colorSunlight * 0.05, timeMidnight);
	...
	colorBouncedSunlight = mix(colorBouncedSunlight, colorBouncedSunlight * 0.003, timeMidnight);
	...
	colorScatteredSunlight = mix(colorScatteredSunlight, colorScatteredSunlight * 0.003, timeMidnight);
